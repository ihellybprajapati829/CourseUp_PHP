...
<body>
    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="flex-shrink-0 p-4 contact" style="width: 75%;">
            <div class="container">
                <h6 style="color:green;"><?php if (isset($_SESSION['msg'])) {
                                                echo $_SESSION['msg'];
                                            } ?></h6>
                <br>
                ...
                <form action="" method="POST" id="addCourse" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea type="text" class="form-control" rows="3" placeholder="Enter brief description of course" name="cdesc" required></textarea>
                            <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" class="form-control" name="cprice" placeholder="Enter Price : 70000" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="file" class="form-control" name="cimg" placeholder="Enter Course Image" accept="image/*" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addLesson-modal" style="width:100%">Add Lessons</button>
                                </div>
                            </div>
                            <br>
                            <br>
            ...
            <!-- Add Lesson Modal -->
            <div class="modal fade" id="addLesson-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <form action="" method="POST" id="addLesson" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" id="text_editor" class="ckeditor" class="form-control" required></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="submit" class="btn btn-success" name="add_lesson" form="addLesson" style="width:100%" value="Add Lesson">
                                        </div>
                                    </div>
                                </form>
                            </div>
